# TripWise
Welcome to TripWise, an innovative project that enables users to conveniently log in or sign up and discover attractions based on their desired location, time, and budget. With TripWise, users can effortlessly view and organize their saved trips and activities, ensuring a memorable holiday experience. Whether you're seeking a budget-friendly getaway packed with exciting activities, TripWise is the perfect app for you.
...
2. Choose to sign up or log in. If you prefer to explore the app without creating an account, you can use the following credentials:
  - Username: 'guest'
  - Password: 'guest'
...
- Allow users to customize trip names according to their preferences.
...
- Enable users to edit and utilize the budget while on their trip.
